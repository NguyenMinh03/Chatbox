    ...
    (set, get) => ({
      ...
      fetchMessages: async (conversationId) => {
        ...
        try {
          ...
          console.error("fail when fetchMessages:", error);
        } finally {
      ...
      updateConversation: (conversation) => {
       ...
       markAsSeen: async () => {
        try {
          ...
          console.error("fail when call marAsSeen in store", error);
        }
      },
       addConvo: (convo) => {
        set((state) => {
      ...
      createConversation: async (type, name, memberIds) => {
        try {
          ...
          console.error("fail when create createConversation in store", error);
        } finally {
          set({ loading: false });
        }
      },
